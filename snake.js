...
window.onload = function() {
    ...
    // update();
    setInterval(update, 100); // Increased speed to 100 milliseconds for better gameplay
}
...
function update() {
    ...
    if (snakeX == foodX && snakeY == foodY) {
        ...
        document.getElementById("score").innerText = "Score: " + score; // Update score in HTML
...
function restartGame() {
    ...
    placeFood();
    update(); // Start the game immediately after restarting
}
